...
3. [Powerlevel10k](https://github.com/romkatv/powerlevel10k#getting-started)
4. 系统终端的配色方案
   1. 下载
   ...
   2. 打开终端，按「⌘ + ,」打开终端偏好设置，点击「描述文件 > ⚙︎⌄ > 导入」，选择「osx-terminal…ors-solarized/xterm 256 color」
5. 插件
    ...
    # 添加以下内容到 .zshrc 末尾（上面三条命令运行结束会有提示）
